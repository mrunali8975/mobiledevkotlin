      ...
      <ScrollView>
        <View style={css.cartOptionWrap}>
          <View style={css.cartOption1Wrap}>
            <Text style={css.cartOption1text}>Flipkart (1)</Text>
          </View>
          <View flex={1} style={[css.cartOption2Wrap]}>
            <Text style={css.cartOption2text}>Grocery</Text>
          </View>
        </View>
            ...
            <View
              ...
              <View style={{width: '70%', alignSelf: 'center'}}>
                <Text
                  ...
                  numberOfLines={1}>
                  Deliver to : Jyotishm..., 786602m..., 786602m..., 786602m...,
                  786602m..., 786602
                </Text>
              </View>
              <Text
          ...
          <View style={{flexDirection: 'row'}}>
            <View style={{flexDirection: 'row', width: '70%'}}>
              <View style={{padding: 10, flexDirection: 'column'}}>
                ...
                <Text style={{marginVertical: 5}}>21 Gear, Multicolor</Text>
                ...
                <View
                  ...
                  <Image
                    style={{width: 12, height: 12, padding: 7}}
                    source={coin}
                  />
                ...
                <View
                  ...
                  <Text style={{color: '#388e3c', fontWeight: '700'}}>
                    1 offer applied{' '}
                  </Text>
          ...
          <View
            ...
            <View
              ...
              <Image
                ...
                source={cartSaveForLater}
              />
              <Text
                style={{textAlign: 'center', color: '#111', fontWeight: '600'}}>
                {' '}
                Save for later
              </Text>
            </View>
            <View
              style={{
                ...
                justifyContent: 'center',
                paddingVertical: 17,
                // borderLeftWidthWidth: 1,
                borderColor: '#dedede',
              }}>
              <Image
                style={{height: 20, width: 15, tintColor: '#a2a2a2'}}
                source={cartRemove}
              />
              <Text
                style={{textAlign: 'center', color: '#111', fontWeight: '600'}}>
